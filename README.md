...
- **Stripe Android SDK**: `23.13.1` — [stripe/stripe-android](https://github.com/stripe/stripe-android)
- **Stripe iOS SDK**: `26.4.1` — [stripe/stripe-ios](https://github.com/stripe/stripe-ios)
